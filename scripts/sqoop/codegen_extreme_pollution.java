// ORM class for table 'extreme_pollution'
...
public class extreme_pollution extends SqoopRecord  implements DBWritable, Writable {
  ...
  public boolean equals(Object o) {
    ...
    equal = equal && (this.municipality == null ? that.municipality == null : this.municipality.equals(that.municipality));
    equal = equal && (this.settlement == null ? that.settlement == null : this.settlement.equals(that.settlement));
    equal = equal && (this.oktmo == null ? that.oktmo == null : this.oktmo.equals(that.oktmo));
    equal = equal && (this.water_body == null ? that.water_body == null : this.water_body.equals(that.water_body));
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.municipality = JdbcWritableBridge.readString(4, __dbResults);
    this.settlement = JdbcWritableBridge.readString(5, __dbResults);
    ...
    this.unit = JdbcWritableBridge.readString(13, __dbResults);
  }
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeString(municipality, 4 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(settlement, 5 + __off, 12, __dbStmt);
    ...
    JdbcWritableBridge.writeString(unit, 13 + __off, 12, __dbStmt);
    return 13;
  }
...
this.readFields0(__dataIn);  }
  public void readFields0(DataInput __dataIn) throws IOException {
    ...
    this.municipality = Text.readString(__dataIn);
    }
    if (__dataIn.readBoolean()) { 
        this.settlement = null;
    } else {
    this.settlement = Text.readString(__dataIn);
    }
    if (__dataIn.readBoolean()) { 
        this.oktmo = null;
    } else {
    this.oktmo = Text.readString(__dataIn);
    }
    if (__dataIn.readBoolean()) { 
        this.water_body = null;
    } else {
    this.water_body = Text.readString(__dataIn);
    }
    if (__dataIn.readBoolean()) { 
        this.indicator = null;
    } else {
  ...
  public void write(DataOutput __dataOut) throws IOException {
    ...
    if (null == this.municipality) { 
        ...
        __dataOut.writeBoolean(false);
    Text.writeString(__dataOut, municipality);
    }
    if (null == this.settlement) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    Text.writeString(__dataOut, settlement);
    }
    if (null == this.oktmo) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    Text.writeString(__dataOut, oktmo);
    }
    if (null == this.water_body) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    Text.writeString(__dataOut, water_body);
    }
  ...
  public String toString(DelimiterSet delimiters, boolean useRecordDelim) {
    ...
    __sb.append(fieldDelim);
    __sb.append(FieldFormatter.escapeAndEnclose(municipality==null?"null":municipality, delimiters));
    __sb.append(fieldDelim);
    __sb.append(FieldFormatter.escapeAndEnclose(settlement==null?"null":settlement, delimiters));
    __sb.append(fieldDelim);
    __sb.append(FieldFormatter.escapeAndEnclose(oktmo==null?"null":oktmo, delimiters));
    __sb.append(fieldDelim);
    __sb.append(FieldFormatter.escapeAndEnclose(water_body==null?"null":water_body, delimiters));
    __sb.append(fieldDelim);
  ...
  private void __loadFromFields(List<String> fields) {
    ...
    if (__cur_str.equals("null")) { this.municipality = null; } else {
      this.municipality = __cur_str;
    }
    ...
    if (__cur_str.equals("null")) { this.settlement = null; } else {
      this.settlement = __cur_str;
    }
    ...
    if (__cur_str.equals("null")) { this.oktmo = null; } else {
      this.oktmo = __cur_str;
    }
    ...
    if (__cur_str.equals("null")) { this.water_body = null; } else {
      this.water_body = __cur_str;
    }
  ...
  public Map<String, Object> getFieldMap() {
    ...
    __sqoop$field_map.put("municipality", this.municipality);
    __sqoop$field_map.put("settlement", this.settlement);
    __sqoop$field_map.put("oktmo", this.oktmo);
    __sqoop$field_map.put("water_body", this.water_body);
